 ...
 */
final class Version20240712094522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prestataire_tarif (id INT AUTO_INCREMENT NOT NULL, prestataire_id INT DEFAULT NULL, presta_type_id INT DEFAULT NULL, prix DOUBLE PRECISION DEFAULT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_59FEBAAEBE3DB2B7 (prestataire_id), INDEX IDX_59FEBAAE56D12E25 (presta_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE prestataire_tarif');
