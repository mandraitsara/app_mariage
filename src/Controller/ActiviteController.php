...
class ActiviteController extends AbstractController{
    #[Route('activite/{id_user}', name: "activite.app_mariage")]
    public function activite(Request $request, EntityManagerInterface $entityManager, UserInterface $userInterface, $id_user)
    {
        ...
        //correspond
        $fournisseurs = $entityManager->getRepository(Prestataire::class)->findBy([],[],5);
